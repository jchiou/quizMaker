	...
	var TeacherView = function (_Component) {
	  ...
	  _createClass(TeacherView, [{
	    ...
	    value: function submit() {
	      ...
	      questionCopy.push({ Q: this.state.tempQ, A: this.state.tempAnswer });
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement("input", { type: "text", onChange: this.setQuestion.bind(this) }),
	          _react2.default.createElement(
	            "h5",
	            null,
	            "Answer: "
	          ...
	          ) : _react2.default.createElement("input", { type: "text", onChange: this.setSA.bind(this) })
	        ),
	        _react2.default.createElement(
	          "button",
