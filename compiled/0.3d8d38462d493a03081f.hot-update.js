	...
	var TeacherView = function (_Component) {
	  ...
	  _createClass(TeacherView, [{
	    ...
	    value: function submit() {
	      ...
	      console.log('submitted', $('select.tf option:selected').val());
	      this.state.shortAnswer ? questionCopy.push({ Q: this.state.tempQ, A: this.state.tempA }) : questionCopy.push({ Q: this.state.tempQ, A: $('select.tf option:selected').val() });
	      this.setState({
