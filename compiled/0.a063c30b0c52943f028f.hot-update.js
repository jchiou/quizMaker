	...
	var QuestionView = function QuestionView(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    props.Q > 0 ? _react2.default.createElement(
	      "button",
	      { type: "button", className: "btn btn-default extraMarginTop floatLeft", onClick: props.submit },
	      "Prev"
	    ) : null,
	    _react2.default.createElement(
	      "button",
	    ...
	    _react2.default.createElement(
	      "button",
	      { type: "button", className: "btn btn-default extraMarginTop floatRight", onClick: props.submit },
	      "Next"
	    )
	  );
	};
